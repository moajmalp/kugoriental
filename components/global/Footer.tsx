      ...
      <div className="container-custom py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-xl font-bold mb-4">KUG Oriental Academy</h3>
            <p className="text-accent-300 text-sm mb-4">
              Government Recognized & ISO Certified Institution in Alternative Medicine
            </p>
            {/* Social Links */}
            ...
            <ul className="space-y-2">
              {navigation.main.map((item) => (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="text-accent-300 hover:text-white text-sm transition-colors duration-200"
                  >
                    {item.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-accent-300 text-sm">
              <li>
                {/* Address placeholder */}
                <p>Address details will be added</p>
              </li>
              <li>
                {/* Phone placeholder */}
                <p>Phone details will be added</p>
              </li>
              <li>
                {/* Email placeholder */}
                <p>Email details will be added</p>
              </li>
            </ul>
          </div>
        </div>
