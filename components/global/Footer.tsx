...
const socialLinks = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/kugoriental',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/oriental.academy.kottakkal/?hl=en',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'YouTube',
    href: 'http://www.youtube.com/@iahakottakkal',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            ...
            <div className="space-y-5 animate-fade-up">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white leading-tight">KUG Oriental Academy</h3>
            ...
            <div className="space-y-5 animate-fade-up animation-delay-300">
              ...
              <div className="space-y-4 text-white/70 text-sm">
                <div className="flex items-start space-x-3">
                  ...
                  <a href="https://maps.app.goo.gl/kmFJkaiSNDWyCYuR8" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                    Thoppil square, Malappuram road,<br />Kottakkal, Kerala 676503, India
                  </a>
                </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-6 text-white/50 text-sm">
                ...
                <p className="hidden md:block">
                  Developed by <span><Link href="https://codoacademy.com" target="_blank" rel="noopener noreferrer">CODO AI Innovations</Link></span>
                </p>
              </div>
            </div>
          </div>
